                          ...
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <select required id="my_class_id" name="my_class_id" class="form-control select">
                                      ...
                                      <?php endif; ?>
                                      <?php if(\App\Helpers\getUserTypeHelper::userIsStudent()): ?>
                                          <?php $__currentLoopData = \App\Models\StudentRecord::where('user_id',auth()->user()->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>)
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="<?php echo e(route('payments.invoice', [\App\Helpers\displayMessageHelper::hash($s->user_id)])); ?>" class="dropdown-item">All Payments</a>
                                <?php $__currentLoopData = \App\Helpers\getPaymentHelper::getYears($s->user_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $py): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($py): ?>
                                    <a href="<?php echo e(route('payments.invoice', [\App\Helpers\displayMessageHelper::hash($s->user_id), $py])); ?>" class="dropdown-item"><?php echo e($py); ?></a>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/payments/manage.blade.php ENDPATH**/ ?>