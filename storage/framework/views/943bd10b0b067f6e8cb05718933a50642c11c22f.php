    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="#ut-<?php echo e(\App\Helpers\displayMessageHelper::hash($ut->id)); ?>" class="dropdown-item" data-toggle="tab"><?php echo e($ut->name); ?>s</a>
            ...
            <div class="tab-content">
                    ...
                    <h6>Personal Data</h6>
                        <fieldset>
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(\App\Helpers\displayMessageHelper::hash($ut->id)); ?>"><?php echo e($ut->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                ...
                <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade" id="ut-<?php echo e(\App\Helpers\displayMessageHelper::hash($ut->id)); ?>">                         <table class="table datatable-button-html5-columns">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Photo</th>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    <a href="<?php echo e(route('users.show', \App\Helpers\displayMessageHelper::hash($u->id))); ?>" class="dropdown-item"><i class="icon-eye"></i> View Profile</a>
                                                    
                                                    <a href="<?php echo e(route('users.edit', \App\Helpers\displayMessageHelper::hash($u->id))); ?>" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                <?php if(\App\Helpers\getUserTypeHelper::userIsSuperAdmin()): ?>

                                                        <a href="<?php echo e(route('users.reset_pass', \App\Helpers\displayMessageHelper::hash($u->id))); ?>" class="dropdown-item"><i class="icon-lock"></i> Reset password</a>
                                                        
                                                        <a id="<?php echo e(\App\Helpers\displayMessageHelper::hash($u->id)); ?>" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                        <form method="post" id="item-delete-<?php echo e(\App\Helpers\displayMessageHelper::hash($u->id)); ?>" action="<?php echo e(route('users.destroy', \App\Helpers\displayMessageHelper::hash($u->id))); ?>" class="hidden"><?php echo csrf_field(); ?> <?php echo method_field('delete'); ?></form>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/users/index.blade.php ENDPATH**/ ?>