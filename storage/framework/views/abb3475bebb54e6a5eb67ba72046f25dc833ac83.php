                                    ...
                                    <div class="col-lg-9">
                                        <select data-placeholder="Select Teacher" class="form-control select-search" name="teacher_id" id="teacher_id">
                                            ...
                                            <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('teacher_id') == \App\Helpers\displayMessageHelper::hash($t->id) ? 'selected' : ''); ?> value="<?php echo e(\App\Helpers\displayMessageHelper::hash($t->id)); ?>"><?php echo e($t->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="c<?php echo e($d->id); ?>">                         <table class="table datatable-button-html5-columns">
                            ...
                            <?php $__currentLoopData = $sections->where('my_class.id', $d->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php if($s->teacher_id): ?>
                                    <td><a target="_blank" href="<?php echo e(route('users.show', \App\Helpers\displayMessageHelper::hash($s->teacher_id))); ?>"><?php echo e($s->teacher->name); ?></a></td>
                                        <?php else: ?>
                                        <td> - </td>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/sections/index.blade.php ENDPATH**/ ?>