    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <?php if(\App\Helpers\checkUsersHelper::userIsTeamSAS()): ?>
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Administrative">
                            ...
                            <li class="nav-item nav-item-submenu <?php echo e(in_array(Route::currentRouteName(), ['payments.index', 'payments.create', 'payments.edit', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'nav-item-expanded' : ''); ?>">
                                ...
                                <ul class="nav nav-group-sub">
                                    <?php if(\App\Helpers\checkUsersHelper::userIsAdministrative()): ?>
                                ...
                                <ul class="nav nav-group-sub">
                                    ...
                                    <?php if(\App\Helpers\getUserTypeHelper::userIsTeacher()): ?>
                                      <?php $__currentLoopData = \App\Models\Section::where('teacher_id',auth()->user()->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="nav-item"><a href="<?php echo e(route('students.list', $s->my_class->id)); ?>" class="nav-link "><?php echo e($s->my_class->name); ?></a></li>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(\App\Helpers\checkUsersHelper::userIsTeamSA()): ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('classes.index')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['classes.index','classes.edit']) ? 'active' : ''); ?>"><i class="icon-windows2"></i> <span> Courses</span></a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('sections.index')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['sections.index','sections.edit',]) ? 'active' : ''); ?>"><i class="icon-fence"></i> <span>Classes</span></a>
                    </li>
                ...
                <?php echo $__env->make('pages.'.\App\Helpers\getUserTypeHelper::getUserType().'.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Final-Project\resources\views/partials/menu.blade.php ENDPATH**/ ?>