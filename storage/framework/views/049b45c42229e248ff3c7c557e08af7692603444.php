                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if($sr->my_parent_id): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span><a target="_blank" href="<?php echo e(route('users.show', \App\Helpers\displayMessageHelper::hash($sr->my_parent_id))); ?>"><?php echo e($sr->my_parent->name); ?></a></span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            <tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/students/show.blade.php ENDPATH**/ ?>