                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>You are creating an Exam for the Current Session <strong><?php echo e(\App\Helpers\getSystemInfoHelper::getSetting('current_session')); ?></strong></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/exams/index.blade.php ENDPATH**/ ?>