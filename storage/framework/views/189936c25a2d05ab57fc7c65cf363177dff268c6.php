...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card">
            ...
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="<?php echo e(route('students.update', \App\Helpers\displayMessageHelper::hash($sr->id))); ?>" data-fouc>
                            ...
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choose..."  name="my_parent_id" id="my_parent_id" class="select-search form-control">
                                    ...
                                    <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e((\App\Helpers\displayMessageHelper::hash($sr->parent_id) == \App\Helpers\displayMessageHelper::hash($p->id)) ? 'selected' : ''); ?> value="<?php echo e(\App\Helpers\displayMessageHelper::hash($p->id)); ?>"><?php echo e($p->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/students/edit.blade.php ENDPATH**/ ?>