                ...
                <table class="table table-responsive table-striped">
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="color: darkgreen"><?php echo \App\Helpers\printMarkSheetHelper::getSuffix($exr->where('student_id', $s->user_id)->first()->pos) ?: '-'; ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Final-Project\resources\views/pages/support_team/marks/tabulation/index.blade.php ENDPATH**/ ?>