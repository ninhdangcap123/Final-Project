 ...
 *
 *  Demo JS code for handsontable_custom_checks.html page
 *
 * ---------------------------------------------------------------------------- */
...
var HotCustomChecks = function () {
    ...
    var _componentHotCustomChecks = function () {
        ...
        var hot_html_cells_data = [
            {
                cover: "https://s3.envato.com/files/237764325/icon.png",
                ...
                comments: "<div class='text-orange mb-1'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 35 ratings",
            },
            {
                cover: "https://s3.envato.com/files/91482991/icon.png",
                ...
                comments: "<div class='text-orange mb-1'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 56 ratings",
            },
            {
                cover: "https://s3.envato.com/files/84750409/icon.png",
                ...
                comments: "<div class='text-orange mb-1'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 453 ratings",
            }
        ];
        ...
        var hot_html_header_init = new Handsontable(hot_html_header, {
            ...
            colHeaders: function (col) {
                ...
                switch (col) {
                    case 0:
                        txt = "<span class='mr-2'>Brand</span> <input type='checkbox' class='hot-checker' ";
                    ...
                    case 2:
                        return '<i class="icon-calendar3 mr-2"></i> Date';
