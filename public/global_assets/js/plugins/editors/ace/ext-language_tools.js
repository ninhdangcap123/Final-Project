define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, n) {
    ...
    (function () {
        this.attach = function (e) {
            ...
            var t = e.data.range, n = e.data.action[0] == "r", r = t.start, i = t.end, s = r.row, o = i.row, u = o - s,
                a = i.column - r.column;
            n && (u = -u, a = -a);
            if (!this.$inChange && n) {
    ...
    "use strict";
    var r = e("../edit_session").EditSession, i = e("../virtual_renderer").VirtualRenderer, s = e("../editor").Editor,
        o = e("../range").Range, u = e("../lib/event"), a = e("../lib/lang"), f = e("../lib/dom"), l = function (e) {
            var t = new i(e);
            t.$maxLines = 4;
            var n = new s(t);
            ...
            return d.$tokenizeRow = function (e) {
                ...
                if (t.meta) {
                    ...
                    t.meta.length + t.caption.length < a - 2 && r.push({type: "rightAlignedText", value: t.meta})
                }
                return r
                ...
                var s = this.container, o = window.innerHeight, u = window.innerWidth, a = this.renderer,
                    f = a.$maxLines * t * 1.4, l = e.top + this.$borderSize;
    ...
    (function () {
        this.gatherCompletionsId = 0, this.$init = function () {
            ...
            var n = e.getSession(), r = e.getCursorPosition(), i = n.getLine(r.row),
            ...
            this.gatherCompletions(this.editor, function (t, n) {
                ...
                this.completions = new c(o), this.completions.setFilter(s);
        ...
        name: "startAutocomplete", exec: function (e) {
            e.completer || (e.completer = new l), e.completer.autoInsert = e.completer.autoSelect = !0, e.completer.showPopup(e), e.completer.cancelContextMenu()
    ...
    function m(e) {
        var t = e.getCursorPosition(), n = e.session.getLine(t.row), r = u.retrievePrecedingIdentifier(n, t.column);
        return e.completers.forEach(function (e) {
            e.identifierRegexps && e.identifierRegexps.forEach(function (e) {
                !r && e && (r = u.retrievePrecedingIdentifier(n, t.column, e))
            })
        }), r
    }
    ...
    var h = {
        ...
        var t = e.editor, n = e.args || "", r = t.completer && t.completer.activated;
        if (e.command.name === "backspace") r && !m(t) && t.completer.detach(); else if (e.command.name === "insertstring") {
            var s = m(t);
            s && !r && (t.completer || (t.completer = new i), t.completer.autoSelect = !1, t.completer.autoInsert = !1, t.completer.showPopup(t))
        }
    }, y = e("../editor").Editor;
    e("../config").defineOptions(y.prototype, "editor", {
        enableBasicAutocompletion: {
            ...
            set: function (e) {
                e ? (this.completers || (this.completers = Array.isArray(e) ? e : c), this.commands.on("afterExec", g)) : this.commands.removeListener("afterExec", g)
            }, value: !1
        }, enableSnippets: {
            set: function (e) {
