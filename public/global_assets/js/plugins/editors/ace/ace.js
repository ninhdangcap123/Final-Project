(function () {
    ...
    function u(e) {
        function l() {
            ...
            if (e.$tooltipFollowsMouse) h(u); else {
                var p = n.$cells[t.session.documentToScreenRow(r, 0)].element, d = p.getBoundingClientRect(),
    ...
    var r = e("./lib/lang"), i = e("./lib/oop"), s = e("./lib/net"), o = e("./lib/event_emitter").EventEmitter,
        u = function () {
            return this
        }(), a = {
            packaged: !1,
    ...
    var r = 2e3, i = function (e) {
        ...
        for (var t in this.states) {
            ...
            for (var a = 0; a < n.length; a++) {
                ...
                Array.isArray(f.token) ? f.token.length == 1 || c == 1 ? f.token = f.token[0] : c - 1 != f.token.length ? (this.reportError("number of courses and regexp groups doesn't match", {
                    rule: f,
                    groupCount: c - 1
        ...
        this.$setMaxTokenCount = function (e) {
            ...
            while (a = u.exec(e)) {
                ...
                for (var y = 0; y < a.length - 2; y++) {
                    ...
                    d = s[o[y]], d.onMatch ? p = d.onMatch(v, i, n) : p = d.token, d.next && (typeof d.next == "string" ? i = d.next : i = d.next(i, n), s = this.states[i], s || (this.reportError("state doesn't exist", i), i = "start", s = this.states[i]), o = this.matchMappings[i], l = m, u = this.regExps[i], u.lastIndex = m);
                    break
                }
            ...
            return h.type && f.push(h), n.length > 1 && n[0] !== i && n.unshift("#tmp", i), {
                tokens: f,
                state: n.length ? n : i
            }
    ...
    "use strict";
    var r = e("./lib/oop"), i = e("./lib/event_emitter").EventEmitter, s = e("./range").Range, o = e("./anchor").Anchor,
        u = function (e) {
    ...
    (function () {
        r.implement(this, i), this.setValue = function (e) {
            ...
            var n = new s(e, 0, t + 1, 0), r = this.$lines.splice(e, t - e + 1),
    ...
    (function () {
        ...
        r.implement(this, o), this.setDocument = function (e) {
            ...
            var t = this.$useWrapMode, n, r = e.data.action, i = e.data.range.start.row, s = e.data.range.end.row,
                o = e.data.range.start, u = e.data.range.end, a = null;
    ...
    var r = e("../lib/oop"), i = e("../lib/dom"), s = e("../lib/lang"), o = e("../lib/useragent"),
        u = e("../lib/event_emitter").EventEmitter, a = 0, f = t.FontMetrics = function (e, t) {
    ...
    (function () {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, v), this.updateCharacterSize = function () {
            ...
            var e = this.session, t = this.$size, n = t.height <= 2 * this.lineHeight,
                r = this.session.getScreenLength(), i = r * this.lineHeight, s = this.scrollTop % this.lineHeight,
                o = t.scrollerHeight + this.lineHeight, u = this.$getLongestLine(),
            ...
            var p = Math.ceil(o / this.lineHeight) - 1,
                d = Math.max(0, Math.round((this.scrollTop - s) / this.lineHeight)), v = d + p, m, g,
                y = this.lineHeight;
    ...
    t.showErrorMarker = function (e, t) {
        ...
        var h = {row: s.row, fixedWidth: !0, coverGutter: !0, el: i.createElement("div")},
