...
//    {
//        return in_array(Auth::user()->user_type, getUsersHelper::getStaff());
//    }
...
//    {
//       switch($class_type){
//           case 'CN1' : return 'Công Nghệ Thông Tin';
//           case 'CN2' : return 'Kỹ Thuật Máy Tính';
//           case 'CN3' : return 'Vật Lý Kỹ Thuật';
//           case 'CN4' : return 'Cơ Kỹ Thuật';
//           case 'CN8' : return 'Khoa Học Máy Tính';
//           case 'CN11' : return 'Tự Động Hóa';
//       }
//        return $class_type;
//    }
