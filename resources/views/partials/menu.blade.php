            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(\App\Helpers\CheckUsersHelper::userIsTeamSA())
                    ...
                    <li class="nav-item">
                        <a href="{{ route('courses.index') }}"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['courses.index','courses.edit']) ? 'active' : '' }}"><i
                                class="icon-windows2"></i> <span> Courses</span></a>
                    </li>
                    ...
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'nav-item-expanded' : '' }}">
                        <a href="#"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'active' : '' }}"><i
                                class="icon-fence"></i>Classes</a>
                        <ul class="nav nav-group-sub">
