                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('payments.update', $payment->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="title" value="{{ $payment->title }}" required type="text"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" title="Class" disabled
                                       value="{{ $payment->my_class_id ? $payment->myCourse->name : 'All Classes' }}"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="method" class="col-lg-3 col-form-label font-weight-semibold">Payment
                                                                                                     Method</label>
                            <div class="col-lg-9">
                                <input title="method" value="{{ ucwords($payment->method) }}" disabled
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input disabled class="form-control" value="{{ $payment->amount }}" id="amount"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" value="{{ $payment->description }}" name="description"
