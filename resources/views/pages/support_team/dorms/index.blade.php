    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-dorms" class="nav-link active" data-toggle="tab">Manage Dorms</a>
                </li>
                <li class="nav-item"><a href="#new-dorm" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i>
                        Create New Dorm</a></li>
            </ul>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                @if(\App\Helpers\GetUserTypeHelper::userIsSuperAdmin())
                                                    {{--Delete--}}
                                                    <a id="{{ $dorm->id }}" onclick="confirmDelete(this.id)" href="#"
                                                       class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $dorm->id }}"
                                                          action="{{ route('dorms.destroy', $dorm->id) }}"
