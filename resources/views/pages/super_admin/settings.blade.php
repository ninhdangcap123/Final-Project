            ...
            <form enctype="multipart/form-data" method="post" action="{{ route('settings.update') }}">
                ...
                <div class="row">
                    <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label for="lock_exam" class="col-lg-3 col-form-label font-weight-semibold">Lock
                                                                                                        Exam</label>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-6">
                                <span
                                    class="font-weight-bold font-italic text-info-800">{{ __('msg.lock_exam') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control"
                                               ...
                                               name="nt_fee_{{ strtolower($ct->code) }}" placeholder="{{ $ct->name }}"
                                               type="text">
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-danger">Submit form <i class="icon-paperplane ml-2"></i>
                    </button>
                </div>
            </form>
        </div>
