                            ...
                            <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                                ...
                                <p>These terms of use are entered into by and between You and {{ $app_name }} ("we" or
                                   ...
                                   (collectively, "Terms of Use"), govern your access to and use of <a target="_blank"
                                                                                                       href="{{ $app_url }}">{{ $app_url }}</a>,
                                   including any content, functionality and services offered on or through <a
                                        target="_blank" href="{{ $app_url }}">{{ $app_url }}</a> (the "Website").</p>

                                <p>Please read the Terms of Use carefully before you start to use the Website. By using
                                   the Website, you accept and agree to be bound and abide by these Terms of Use and our
                                   Privacy Policy, found at <a target="_blank"
                                                               href="{{ route('privacy_policy') }}">{{ route('privacy_policy') }}</a>,
                                   incorporated herein by reference. If you do not want to agree to these Terms of Use
                                   or the Privacy Policy, you must not access or use the Website.</p>
                                ...
                                <p>We may revise and update these Terms of Use from time to time in our sole discretion.
                                   All changes are effective immediately when we post them. However, any changes to the
                                   dispute resolution provisions set forth in Governing Law and Jurisdiction will not
                                   apply to any disputes for which the parties have actual notice prior to the date the
                                   change is posted on the Website.</p>

                                <p>Your continued use of the Website following the posting of revised Terms of Use means
                                   that you accept and agree to the changes. You are expected to check this page from
                                   time to time so you are aware of any changes, as they are binding on you.</p>

                                <h4 class="font-weight-semibold">Accessing The Website And Account Security</h4>
                                <p>We reserve the right to withdraw or amend this Website, and any service or material
                                ...
                                <ul>
                                    ...
                                    <li>Ensuring that all persons who access the Website through your internet
                                ...
                                <p>To access the Website or some of the resources it offers, you may be asked to provide
                                   ...
                                   and complete. You agree that all information you provide to register with this
                                   Website or otherwise, including but not limited to through the use of any interactive
                                   features on the Website, is governed by our Privacy Policy, and you consent to all
                                ...
                                <p>We have the right to disable any user name, password, or other identifier, whether
                                ...
                                <p>The Website and its entire contents, features and functionality (including but not
                                   ...
                                   the design, selection and arrangement thereof), are owned by us, our licensors, or
                                ...
                                <p>These Terms of Use permit you to use the Website for your personal, non-commercial
                                   use only. You must not reproduce, distribute, modify, create derivative works of,
                                   publicly display, publicly perform, republish, download, store, or transmit any of
                                   the material on our Website in violation of any laws.</p>
                                ...
                                <p>The {{ $app_name }} name and all related names, logos, slogans, mottos, and designs
                                   ...
                                   without our prior written permission. All other names, logos, product and service
                                   names, designs and slogans on this Website are the trademarks of their respective
                                   owners.</p>
                                ...
                                <ul>
                                    ...
                                    <li>To impersonate or attempt to impersonate us, one of our employees, another user
                                    ...
                                    <li>To engage in any other conduct that restricts or inhibits anyone's use or
                                        enjoyment of the Website, or which, as determined by us, may harm us or users of
                                ...
                                <ul>
                                    <li>Use the Website in any manner that could disable, overburden, damage, or impair
                                    ...
                                    <li>Use any manual process to monitor or copy any of the material on the Website or
                                    ...
                                    <li>Attack the Website via a denial-of-service attack or a distributed
                                        denial-of-service attack.
                                    </li>
                                    <li>Use the Website in any manner that violates any applicable {{ $app_name }}
                                        policy, rule, or procedure.
                                    </li>
                                    <li>Use the Website in any manner that contravenes Catholic Mercy tradition, faith,
                                        and morals or the legacy of Catholic Mercy education.
                                    </li>
                                ...
                                <p>The Website may contain message boards, chat rooms, personal web pages or profiles,
                                   ...
                                   "User Contributions") on or through the Website.</p>
                                ...
                                <p>Any User Contribution you post to the site will be considered non-confidential and
                                   ...
                                   our licensees, successors and assigns the right to use, reproduce, modify, perform,
                                   display, distribute and otherwise disclose to third parties any such material.</p>

                                <p>You represent and warrant that:</p>

                                <ul>
                                    <li>You own or control all rights in and to the User Contributions and have the
                                        right to grant the license granted above to us and our licensees, successors and
                                        assigns.
                                    </li>
                                    <li> All of your User Contributions do and will comply with these Terms of Use.</li>
                                </ul>

                                <p>You understand and acknowledge that you are responsible for any User Contributions
                                   you submit or contribute, and you, not us, have full responsibility for such content,
                                   including its legality, reliability, accuracy, and appropriateness.</p>

                                <p>We are not responsible, or liable to any third party, for the content or accuracy of
                                   any User Contributions posted by you or any other user of the Website.</p>
                                ...
                                <ul>
                                    ...
                                    <li>Take any action with respect to any User Contribution that we deem necessary or
                                        ...
                                        entity, threatens the personal safety of users of the Website or the public or
                                        could create liability for us.
                                    </li>
                                    <li>Disclose your identity or other information about you to any third party who
                                ...
                                <p>YOU WAIVE AND HOLD HARMLESS {{ strtoupper($app_name) }} FROM ANY CLAIMS RESULTING
                                   FROM ANY ACTION TAKEN BY {{ strtoupper($app_name) }} DURING OR AS A RESULT OF ITS
                                   INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS A CONSEQUENCE OF INVESTIGATIONS
                                   BY {{ strtoupper($app_name) }} OR LAW ENFORCEMENT AUTHORITIES.</p>

                                <p>However, we do not undertake to review all material before it is posted on the
                                   ...
                                   have no liability or responsibility to anyone for performance or nonperformance of
                                   the activities described in this section.</p>

                                <h4 class="font-weight-semibold">Content Standards</h4>

                                <p>These content standards apply to any and all User Contributions and use of
                                   ...
                                   limiting the foregoing, User Contributions must not:</p>

                                <ul>
                                    <li> Contain any material which is defamatory, obscene, indecent, abusive,
                                    ...
                                    <li>Violate the legal rights (including the rights of publicity and privacy) of
                                        ...
                                        conflict with these Terms of Use and our <a target="_blank"
                                                                                    href="{{ route('privacy_policy') }}">Privacy
                                                                                                                         Policy</a>.
                                    </li>
                                    <li>Be likely to deceive any person.</li>
                                    <li>Promote any illegal activity, or advocate, promote or assist any unlawful act.
                                    </li>
                                ...
                                <p>If you believe that any User Contributions violate your copyright, please contact
                                   us</p>

                                <h5 class="font-weight-semibold">Reliance on Information Posted</h5>

                                <p>The information presented on or through the Website is made available solely for
                                   ...
                                   any reliance placed on such materials by you or any other visitor to the Website, or
                                   by anyone who may be informed of any of its contents.</p>

                                <p>This Website may include content provided by third parties, including materials
                                   provided by other users, bloggers and third-party licensors, syndicators, aggregators
                                   and/or reporting services. All statements and/or opinions expressed in these
                                   materials, and all articles and responses to questions and other content, other than
                                   the content provided by us, are solely the opinions and the responsibility of the
                                   person or entity providing those materials. These materials do not necessarily
                                   reflect the opinion of us. We are not responsible, or liable to you or any third
                                ...
                                <p>All information we collect on this Website is subject to our Privacy Policy. By using
                                   the Website, you consent to all actions taken by us with respect to your information
                                   in compliance with the <a target="_blank" href="{{ route('privacy_policy') }}">Privacy
                                                                                                                  Policy</a>.
                                </p>
                                ...
                                <p>You agree to cooperate with us in removing any link we ask you to. We reserve the
                                   right to withdraw linking permission without notice.</p>

                                <p>We may disable all or any social media features and any links at any time without
                                   notice in our discretion.</p>
                                ...
                                <p>If the Website contains links to other sites and resources provided by third parties,
                                   ...
                                   control over the contents of those sites or resources, and accept no responsibility
                                   for them or for any loss or damage that may arise from your use of them. If you
                                   decide to access any of the third party websites linked to this Website, you do so
                                ...
                                <p>You understand that we cannot and do not guarantee or warrant that files available
                                   ...
                                   OBTAINED THROUGH THE WEBSITE OR TO YOUR DOWNLOADING OF ANY MATERIAL POSTED ON IT, OR
                                ...
                                <p>YOUR USE OF THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE
                                   ...
                                   NEITHER {{ strtoupper($app_name) }} NOR ANY PERSON ASSOCIATED
                                   WITH {{ strtoupper($app_name) }} MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO
                                   THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY OR AVAILABILITY OF THE
                                   WEBSITE. WITHOUT LIMITING THE FOREGOING, NEITHER {{ strtoupper($app_name) }} NOR
                                   ANYONE ASSOCIATED WITH {{ strtoupper($app_name) }} REPRESENTS OR WARRANTS THAT THE
                                   ...
                                   OUR SITE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL
                                   COMPONENTS OR THAT THE WEBSITE OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE
                                   WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS.</p>

                                <p>{{ strtoupper($app_name) }} HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
                                                               EXPRESS OR IMPLIED, STATUTORY OR OTHERWISE, INCLUDING BUT
                                                               NOT LIMITED TO ANY WARRANTIES OF NON-INFRINGEMENT.</p>
                                ...
                                <p>IN NO EVENT WILL {{ strtoupper($app_name) }}, ITS AFFILIATES OR THEIR LICENSORS,
                                   ...
                                   INABILITY TO USE, THE WEBSITE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE WEBSITE
                                   OR SUCH OTHER WEBSITES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE OR SUCH
                                ...
                                <p>You agree to defend, indemnify and hold harmless {{ $app_name }}, its affiliates,
                                   ...
                                   limited to, your User Contributions, any use of the Website's content, services and
                                ...
                                <p>All matters relating to the Website and these Terms of Use and any dispute or claim
                                   ...
                                   of Nigeria without giving effect to any choice or conflict of law provision or
                                   rule.</p>

                                <p>Any legal suit, action or proceeding arising out of, or related to, these Terms of
                                   Use or the Website shall be instituted exclusively in the federal courts of Nigeria,
                                ...
                                <p>ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS
                                   OF USE OR THE WEBSITE MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION
                                ...
                                <p>No waiver of by {{ $app_name }} of any term or condition set forth in these Terms of
                                   Use shall be deemed a further or continuing waiver of such term or condition or a
                                   waiver of any other term or condition, and any failure of {{ $app_name }} to assert a
                                   right or provision under these Terms of Use shall not constitute a waiver of such
                                   right or provision.</p>

                                <p>If any provision of these Terms of Use is held by a court or other tribunal of
                                   ...
                                   remaining provisions of the Terms of Use will continue in full force and effect.</p>

                                <h4 class="font-weight-semibold">Entire Agreement</h4>

                                <p>These Terms of Use and our <a target="_blank" href="{{ route('privacy_policy') }}">Privacy
                                                                                                                      Policy</a>
                                   constitute the sole and entire agreement between you and {{ $app_name }} with respect
                                   to the Website and supersede all prior and contemporaneous understandings,
                                ...
                                <p>If you do have any comments or concerns regarding but not limited to these Terms of
                                ...
                                <p>All other feedback, comments, requests for technical support and other communications
                                   relating to the Website should be directed to the School Administrator. Please
